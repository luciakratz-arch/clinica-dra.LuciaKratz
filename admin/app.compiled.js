...
function Login({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "login-crp"
  }, "Psicologa Doutora · CRP 09/20590"), /*#__PURE__*/React.createElement("div", {
    ...
    name: "activity",
    size: 14
  }), " Área Clínica"), /*#__PURE__*/React.createElement("a", {
    href: "../",
    style: {
      color: "var(--gray-400)",
      fontSize: 12
...
<p>Goiânia, GO · CRP 09/20590</p></div></div></body></html>`
  ...
  }, [["lancamentos", "Lançamentos", "dollar-sign"], ["pacotes", "Pacotes & Sessões", "package"], ["acompanhamento", "Acompanhamento Geral", "users"], ["comissoes", "Comissões", "percent"]].map(([id, lbl, ic]) => /*#__PURE__*/React.createElement("button", {
    key: id,
    onClick: () => setAba(id),
    style: {
      padding: "10px 20px",
...
<div class="footer">Documento gerado em ${new Date().toLocaleDateString("pt-BR")} às ${new Date().toLocaleTimeString("pt-BR", {
  ...
  })), aba === "comissoes" && /*#__PURE__*/React.createElement(Comissoes, {
    user: user
...
function Alunos() {
  ...
  return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
    ...
    className: "page-title"
  }, "Alunos em Supervisão"), /*#__PURE__*/React.createElement("div", {
    className: "page-subtitle"
  }, alunos.filter(a => a.status === "ativo").length, " aluno(s) cadastrado(s)")), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      gap: 8,
      flexWrap: "wrap"
  ...
  }, linkCopiado ? "✓ Texto copiado!" : "📋 Link de Cadastro"), /*#__PURE__*/React.createElement("button", {
    className: "btn btn-purple",
    onClick: () => {
      setForm({
        nome: "",
    ...
    name: "user-plus",
    size: 16
  }), " Cadastrar Aluno"))), pendentes.length > 0 && /*#__PURE__*/React.createElement("div", {
    style: {
      background: "#fef3c7",
      border: "1px solid #f59e0b",
      borderRadius: 12,
  ...
  }, "🔔 ", pendentes.length, " solicitação(ões) pendente(s)"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 12,
      color: "#78350f",
      marginTop: 2
    }
  }, "Alunos que se cadastraram pelo link e aguardam sua aprovação.")), /*#__PURE__*/React.createElement("button", {
    className: "btn btn-ghost",
    style: {
      fontSize: 12,
      color: "#92400e",
  ...
  }, "Ver pendentes")), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      gap: 12,
      marginBottom: 20,
    ...
    value: busca,
    onChange: e => setBusca(e.target.value)
  }), [["todos", "Todos"], ["ativo", "Ativos"], ["pendente", "Pendentes"], ["inativo", "Inativos"]].map(([f, l]) => /*#__PURE__*/React.createElement("button", {
    key: f,
    className: "btn " + (filtro === f ? "btn-purple" : "btn-ghost"),
    onClick: () => setFiltro(f)
  }, l, " ", f === "pendente" && pendentes.length > 0 && /*#__PURE__*/React.createElement("span", {
    style: {
      background: "#f59e0b",
      color: "white",
      borderRadius: 20,
  ...
  }, pendentes.length)))), filtrados.length === 0 ? /*#__PURE__*/React.createElement("div", {
    className: "card",
    style: {
      textAlign: "center",
      padding: 48,
  ...
  }, a.status === "ativo" ? "Ativo" : a.status === "pendente" ? "⏳ Pendente" : "Inativo"), a.origemCadastro === "auto-cadastro" && /*#__PURE__*/React.createElement("span", {
    style: {
      fontSize: 10,
      color: "var(--text-muted)",
  ...
  }, "auto-cadastro")), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 13,
      color: "var(--text-muted)",
      display: "flex",
  ...
  }, a.status === "pendente" && /*#__PURE__*/React.createElement("button", {
    className: "btn btn-purple",
    style: {
      fontSize: 12,
      padding: "6px 14px"
  ...
  }, "✓ Aprovar"), a.status === "ativo" && /*#__PURE__*/React.createElement("button", {
    className: "btn btn-ghost",
    style: {
      fontSize: 11,
      padding: "5px 10px",
  ...
  }, "Inativar"), a.status === "inativo" && /*#__PURE__*/React.createElement("button", {
    className: "btn btn-ghost",
    style: {
      fontSize: 11,
      padding: "5px 10px",
...
function Laudos() {
  ...
  return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
    ...
    className: "page-subtitle"
  }, laudos.length, " laudo(s) · ", totalEnviado, " enviado(s) ao paciente")), /*#__PURE__*/React.createElement("button", {
    className: "btn btn-purple",
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      name: "check-circle",
      size: 14
    }), " Disponível no portal do paciente"), l.status !== "arquivado" && /*#__PURE__*/React.createElement("button", {
      className: "btn btn-ghost",
      style: {
        fontSize: 12
      },
  ...
  }, "No Drive: botão direito no arquivo → \"Obter link\" → cole aqui")), /*#__PURE__*/React.createElement("div", {
    className: "form-group",
    style: {
      marginBottom: 20
    }
    ...
    className: "form-label"
  }, "Observações internas (opcional)"), /*#__PURE__*/React.createElement(TextAreaVoz, {
    className: "form-input",
    rows: 2,
...
function Comissoes({
  ...
  return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
    ...
    className: "page-title"
  }, "Comissões — ", config.nomeSecretaria.split(" ")[0]), /*#__PURE__*/React.createElement("div", {
    className: "page-subtitle"
  }, "Salário fixo R$ ", SALARIO_FIXO.toFixed(2).replace(".", ","), " + comissões por vendas · Repasses a parceiras")), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      gap: 8,
      flexWrap: "wrap",
    ...
    name: "trash-2",
    size: 13
  }), "🧹 Limpar Duplicatas"), /*#__PURE__*/React.createElement("button", {
    ...
    name: "search",
    size: 13
  }), "🔍 Auditar Jun/Jul"))), modalAuditComissao && /*#__PURE__*/React.createElement("div", {
    style: {
      position: "fixed",
      inset: 0,
      background: "rgba(0,0,0,0.5)",
  ...
  }, "🔍 Auditoria de Comissões — Jun/Jul 2026"), /*#__PURE__*/React.createElement("button", {
  ...
  }, "×")), auditando ? /*#__PURE__*/React.createElement("div", {
    style: {
      textAlign: "center",
      padding: 40,
      color: "var(--text-muted)"
    }
  }, "Analisando pacotes e comissões...") : auditResultado && (() => {
    const {
      pacotesPagos,
      pacotesPendentes,
      pagosComComissao,
    ...
    return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
    ...
    }, pacotesPagos.length), /*#__PURE__*/React.createElement("div", {
      style: {
        fontSize: 12,
        color: "#166534"
      }
    }, "Pacotes pagos jun/jul")), /*#__PURE__*/React.createElement("div", {
      style: {
        background: "#f5f0ff",
        borderRadius: 10,
        padding: 14,
    ...
    }, pagosComComissao.length), /*#__PURE__*/React.createElement("div", {
      style: {
        fontSize: 12,
        color: "#4c1d95"
      }
    }, "Com comissão ✓")), /*#__PURE__*/React.createElement("div", {
      style: {
    ...
    }, pagosSemComissao.length), /*#__PURE__*/React.createElement("div", {
      style: {
        fontSize: 12,
        color: pagosSemComissao.length > 0 ? "#7f1d1d" : "#166534"
      }
    }, pagosSemComissao.length > 0 ? "⚠️ Sem comissão!" : "Tudo ok ✓"))), pagosSemComissao.length > 0 && /*#__PURE__*/React.createElement("div", {
      style: {
        marginBottom: 20
      }
    }, /*#__PURE__*/React.createElement("div", {
    ...
    }, "⚠️ Pacotes pagos SEM comissão registrada"), /*#__PURE__*/React.createElement("button", {
    ...
    }, "✚ Gerar todas (", pagosSemComissao.length, ")")), pagosSemComissao.map(p => /*#__PURE__*/React.createElement("div", {
      key: p.id,
      style: {
        display: "flex",
        justifyContent: "space-between",
    ...
    }, p.pacienteNome || "—"), /*#__PURE__*/React.createElement("div", {
      style: {
        fontSize: 11,
        color: "#6b7280"
      }
    }, p.dataInicio, " · ", fmtVal(p.valorTotal), " · ", p.recorrencia)), /*#__PURE__*/React.createElement("button", {
    ...
    }, "✚ Gerar comissão")))), pagosComComissao.length > 0 && /*#__PURE__*/React.createElement("div", {
      style: {
        marginBottom: 20
      }
    }, /*#__PURE__*/React.createElement("div", {
    ...
    }, "✓ Pacotes com comissão registrada"), pagosComComissao.map(p => {
      ...
      }, p.dataInicio, " · ", fmtVal(p.valorTotal))), /*#__PURE__*/React.createElement("div", {
        style: {
          textAlign: "right"
        }
      }, /*#__PURE__*/React.createElement("div", {
      ...
      }, "✓ Comissão: ", fmtVal(com?.valorComissao)), /*#__PURE__*/React.createElement("div", {
        style: {
          fontSize: 10,
          color: "#9ca3af"
        }
      }, com?.status === "pago" ? "Paga" : "Pendente")));
    })), pacotesPendentes.length > 0 && /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
      style: {
        fontWeight: 700,
        fontSize: 13,
        color: "#b45309",
    ...
    }, "⏳ Pacotes ainda pendentes de pagamento (", pacotesPendentes.length, ")"), pacotesPendentes.map(p => /*#__PURE__*/React.createElement("div", {
      key: p.id,
      style: {
        display: "flex",
        justifyContent: "space-between",
    ...
    }, listaMeses.map(m => /*#__PURE__*/React.createElement("button", {
      key: m,
      onClick: () => setMesSel(m),
      style: {
        padding: "6px 14px",
    ...
    }, getMesLabel(m)))), /*#__PURE__*/React.createElement("button", {
      onClick: irProx,
      disabled: idxAtual <= 0,
      style: {
        width: 32,
    ...
    }, idxAtual + 1, "/", listaMeses.length));
  })(), user.tipo === "psicologa" && /*#__PURE__*/React.createElement("div", {
    style: {
      background: "white",
      borderRadius: 14,
      border: "1px solid var(--gray-200)",
  ...
  }, "⚙️ Configurações de Salário e Percentuais"), !editandoConfig ? /*#__PURE__*/React.createElement("button", {
    onClick: () => {
      setFormConfig({
        ...config
      });
  ...
  }, salvandoConfig ? "Salvando..." : "💾 Salvar"))), !editandoConfig ? /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      flexWrap: "wrap",
      gap: "8px 24px",
  ...
  }, /*#__PURE__*/React.createElement("span", null, "👩‍💼 Secretária: ", /*#__PURE__*/React.createElement("strong", null, config.nomeSecretaria)), /*#__PURE__*/React.createElement("span", null, "💵 Salário fixo: ", /*#__PURE__*/React.createElement("strong", null, "R$ ", SALARIO_FIXO.toFixed(2).replace(".", ","))), /*#__PURE__*/React.createElement("span", null, "🌟 Primeira venda: ", /*#__PURE__*/React.createElement("strong", null, config.percPrimeira, "%")), /*#__PURE__*/React.createElement("span", null, "🔁 Recorrente: ", /*#__PURE__*/React.createElement("strong", null, config.percRecorrente, "%")), /*#__PURE__*/React.createElement("span", null, "🤝 Parceiro (padrão): ", /*#__PURE__*/React.createElement("strong", null, config.percParceiroPadrao, "%"))) : /*#__PURE__*/React.createElement("div", {
    style: {
      display: "grid",
    ...
    className: "form-label"
  }, "Nome da secretária"), /*#__PURE__*/React.createElement("input", {
    className: "form-input",
    ...
    className: "form-label"
  }, "Salário fixo (R$)"), /*#__PURE__*/React.createElement("input", {
    className: "form-input",
    type: "number",
    ...
    className: "form-label"
  }, "% primeira venda"), /*#__PURE__*/React.createElement("input", {
    className: "form-input",
    type: "number",
    ...
    className: "form-label"
  }, "% recorrente"), /*#__PURE__*/React.createElement("input", {
    className: "form-input",
    type: "number",
    ...
    className: "form-label"
  }, "% parceiro padrão"), /*#__PURE__*/React.createElement("input", {
    className: "form-input",
    type: "number",
  ...
  }, "Os novos percentuais valem para as próximas vendas; comissões já registradas não mudam.")), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "grid",
      gridTemplateColumns: "repeat(auto-fit,minmax(160px,1fr))",
      gap: 16,
  ...
  }, "Salário Fixo"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 22,
      fontWeight: 700,
      color: "var(--text)"
    }
  }, "R$ ", SALARIO_FIXO.toFixed(2).replace(".", ","))), /*#__PURE__*/React.createElement("div", {
    style: {
      background: "var(--gray-50)",
      borderRadius: 14,
      padding: "18px 20px",
  ...
  }, "Comissões Pendentes"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 22,
      fontWeight: 700,
      color: "#7B00C4"
    }
  }, "R$ ", totalPend.toFixed(2).replace(".", ",")), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 11,
      color: "var(--text-muted)",
      marginTop: 4
    }
  }, comissoesPend.length, " venda(s) nova(s)", totalPagas > 0 && /*#__PURE__*/React.createElement("span", {
    style: {
      color: "#16a34a"
    }
  }, " · ✓ R$ ", totalPagas.toFixed(2).replace(".", ","), " já pagas no mês"))), /*#__PURE__*/React.createElement("div", {
    style: {
  ...
  }, "Total a Pagar ", salarioJaPago ? "(novo ciclo)" : ""), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 26,
      fontWeight: 800,
      color: totalAPagar === 0 ? "#16a34a" : "#7B00C4"
    }
  }, totalAPagar === 0 ? "✓ Tudo pago" : `R$ ${totalAPagar.toFixed(2).replace(".", ",")}`), pagamentoMes && /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 11,
      color: "#16a34a",
      marginTop: 4,
  ...
  }, "Último pagamento em ", pagamentosDoMes[0].data?.split("-").reverse().join("/"), " · ", pagamentosDoMes.length, " pagamento(s) no mês"))), user.tipo === "psicologa" && /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      gap: 10,
      marginBottom: 24,
  ...
  }, totalAPagar > 0 && (salarioJaPago ? comissoesPend.length > 0 : true) && /*#__PURE__*/React.createElement("button", {
    ...
    }, "🎁 Registrar Gratificação"), showGrat && /*#__PURE__*/React.createElement("div", {
      style: {
        marginTop: 10,
        background: "#f5f0ff",
        border: "1px solid #c4b5fd",
    ...
    }, "🎁 Gratificação para ", config.nomeSecretaria), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("label", {
      style: {
        fontSize: 11,
        fontWeight: 600,
        color: "#6b7280",
    ...
    }, salvGrat ? "Salvando..." : "✓ Confirmar"), /*#__PURE__*/React.createElement("button", {
...
<div class="footer">Gerado em ${new Date().toLocaleDateString("pt-BR")} às ${new Date().toLocaleTimeString("pt-BR", {
  ...
  }, "🔄 Ciclo Atual (a pagar) — ", config.nomeSecretaria.split(" ")[0], " — ", getMesLabel(mesSel)), comissoesPend.length === 0 ? /*#__PURE__*/React.createElement("div", {
    style: {
      padding: "30px 20px",
      textAlign: "center",
      color: "var(--text-muted)",
  ...
  }, "✓ Nenhuma comissão pendente — novas vendas aparecem aqui e reabrem o pagamento") : comissoesPend.map(c => {
    ...
    }, c.pacienteNome || "—"), /*#__PURE__*/React.createElement("div", {
      style: {
        fontSize: 12,
        color: "var(--text-muted)",
        marginTop: 2
      }
    }, c.tipo, " · ", dataStr), c.pacoteId && /*#__PURE__*/React.createElement("div", {
      style: {
        fontSize: 10,
        color: "#9ca3af",
        marginTop: 1
    ...
    }, "+R$ ", (c.valorComissao || 0).toFixed(2).replace(".", ","))), user.tipo === "psicologa" && /*#__PURE__*/React.createElement("button", {
  ...
  })), comissoesSuspeitas.length > 0 && /*#__PURE__*/React.createElement("div", {
    style: {
      background: "#fffbeb",
      borderRadius: 14,
      border: "1px solid #fde68a",
  ...
  }, "⏳ Aguardando pagamento do pacote — ", comissoesSuspeitas.length, " comissão(ões) fora do ciclo"), /*#__PURE__*/React.createElement("span", {
    style: {
      fontSize: 11,
      color: "#92400e"
    }
  }, "Entram automaticamente quando o pacote for marcado como pago")), comissoesSuspeitas.map(c => {
    const pacoteVinc = c.pacoteId ? pacotes.find(p => p.id === c.pacoteId) : null;
    ...
    }, c.pacienteNome || "-"), semPacote && /*#__PURE__*/React.createElement("span", {
      style: {
        fontSize: 10,
        background: "#fca5a5",
        color: "#7f1d1d",
    ...
    }, "Pacote removido"), pacoteVinc && /*#__PURE__*/React.createElement("span", {
      style: {
        fontSize: 10,
        background: "#fed7aa",
        color: "#7c2d12",
    ...
    }, "Pacote pendente · R$ ", (pacoteVinc.valorTotal || 0).toFixed(2).replace(".", ","))), /*#__PURE__*/React.createElement("div", {
      style: {
        fontSize: 11,
        color: "#92400e",
        marginTop: 2
      }
    }, c.tipo, " · ", dataStr)), /*#__PURE__*/React.createElement("div", {
      style: {
        display: "flex",
        alignItems: "center",
        gap: 10
    ...
    }, "Comissão prevista"), /*#__PURE__*/React.createElement("div", {
      style: {
        fontWeight: 700,
        fontSize: 14,
        color: "#b45309"
  ...
  })), (comissoesPagas.length > 0 || pagamentosDoMes.length > 0) && /*#__PURE__*/React.createElement("div", {
    style: {
      background: "white",
      borderRadius: 14,
      border: "1px solid var(--gray-200)",
  ...
  }, /*#__PURE__*/React.createElement("span", null, "✓ Histórico — ", getMesLabel(mesSel)), /*#__PURE__*/React.createElement("span", {
    style: {
      fontSize: 13,
      color: "#16a34a",
      fontWeight: 600
    }
  }, "R$ ", totalPagas.toFixed(2).replace(".", ","), " em comissões pagas")), pagamentosDoMes.length > 0 && /*#__PURE__*/React.createElement("div", {
    style: {
      padding: "10px 20px",
      background: "#f0fdf4",
      borderBottom: "1px solid var(--gray-100)"
    }
  }, pagamentosDoMes.map(pg => /*#__PURE__*/React.createElement("div", {
    key: pg.id,
    style: {
      display: "flex",
      justifyContent: "space-between",
  ...
  }, "💰 ", pg.tipo, " — ", pg.data?.split("-").reverse().join("/"), pg.qtdComissoes ? ` · ${pg.qtdComissoes} comissão(ões)` : "", (pg.valorSalarioFixo || 0) > 0 ? ` · inclui salário fixo` : ""), /*#__PURE__*/React.createElement("strong", {
    style: {
      color: "#166534"
    }
  }, "R$ ", (pg.valor || 0).toFixed(2).replace(".", ","))))), comissoesPagas.map(c => /*#__PURE__*/React.createElement("div", {
    key: c.id,
    style: {
      display: "flex",
      justifyContent: "space-between",
  ...
  }, c.tipo, " · ", labelTipoVenda(c.tipoVenda), " · pago em ", c.dataPagamento ? c.dataPagamento.split("-").reverse().join("/") : "—")), /*#__PURE__*/React.createElement("div", {
    style: {
      fontWeight: 700,
      fontSize: 14,
      color: "#16a34a"
    }
  }, "✓ R$ ", (c.valorComissao || 0).toFixed(2).replace(".", ","))))), /*#__PURE__*/React.createElement("div", {
    style: {
      background: "white",
      borderRadius: 14,
      border: "1px solid var(--gray-200)",
  ...
  }, "🤝 Repasses a Parceiras — ", getMesLabel(mesSel)), responsaveis.length === 0 ? /*#__PURE__*/React.createElement("div", {
    style: {
      padding: "30px 20px",
      textAlign: "center",
      color: "var(--text-muted)",
  ...
  }, "Nenhum repasse neste mês. Vendas em parceria aparecem aqui automaticamente.") : responsaveis.map(resp => {
    ...
    }, itens.length, " venda(s) · Total R$ ", totalResp.toFixed(2).replace(".", ","), parc?.pix ? ` · PIX: ${parc.pix}` : "")), /*#__PURE__*/React.createElement("div", {
      style: {
        display: "flex",
        alignItems: "center",
        gap: 12
    ...
    }, "R$ ", totalPend.toFixed(2).replace(".", ","))), user.tipo === "psicologa" && totalPend > 0 && /*#__PURE__*/React.createElement("button", {
    ...
    }, pagando ? "..." : "💸 Marcar como pago"))), itens.map(c => /*#__PURE__*/React.createElement("div", {
      key: c.id,
      style: {
        display: "flex",
        justifyContent: "space-between",
    ...
    }, c.tipo, " · ", c.perc ? `${c.perc}% de R$ ${(c.valorBase || 0).toFixed(2).replace(".", ",")}` : "")), /*#__PURE__*/React.createElement("div", {
      style: {
        textAlign: "right"
      }
    }, /*#__PURE__*/React.createElement("div", {
    ...
    }, "✓ Pago ", c.dataPagamento ? c.dataPagamento.split("-").reverse().join("/") : "") : /*#__PURE__*/React.createElement("div", {
      style: {
        fontSize: 11,
        color: "#b45309",
        fontWeight: 600
  ...
  }, /*#__PURE__*/React.createElement("span", null, "Parceiras Cadastradas"), /*#__PURE__*/React.createElement("button", {
    onClick: () => {
      setEditandoParceira(null);
      setFormParceira({
        nome: "",
  ...
  }, "+ Nova Parceira")), parceiras.length === 0 ? /*#__PURE__*/React.createElement("div", {
    style: {
      padding: "30px 20px",
      textAlign: "center",
      color: "var(--text-muted)",
  ...
  }, "Nenhuma parceira cadastrada. Cadastre para usar nas vendas em parceria.") : parceiras.map(p => /*#__PURE__*/React.createElement("div", {
    key: p.id,
    style: {
      display: "flex",
      justifyContent: "space-between",
  ...
  }, p.nome, " ", p.tipo === "estagiaria" && /*#__PURE__*/React.createElement("span", {
    style: {
      fontSize: 10,
      fontWeight: 700,
      background: "#ccfbf1",
  ...
  }, "Estagiária")), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 12,
      color: "var(--text-muted)"
    }
  }, "Repasse padrão: ", p.percentual || config.percParceiroPadrao, "% ", p.pix ? ` · PIX: ${p.pix}` : "")), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      gap: 6
    }
  ...
  }, "🗑️"))))), modalParceira && /*#__PURE__*/React.createElement("div", {
    style: {
      position: "fixed",
      inset: 0,
      background: "rgba(0,0,0,0.4)",
  ...
  }, editandoParceira ? "Editar Parceira" : "Nova Parceira"), /*#__PURE__*/React.createElement("div", {
    className: "form-group",
    style: {
      marginBottom: 14
    }
    ...
    className: "form-label"
  }, "% de repasse padrão"), /*#__PURE__*/React.createElement("input", {
    className: "form-input",
    type: "number",
    min: "0",
    max: "100",
    ...
    className: "form-label"
  }, "Chave PIX (opcional)"), /*#__PURE__*/React.createElement("input", {
    className: "form-input",
    ...
    value: "parceira"
  }, "Parceira (vendas em parceria)"), /*#__PURE__*/React.createElement("option", {
    value: "estagiaria"
  }, "Estagiária (projeto social)"))), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      gap: 10,
      justifyContent: "flex-end"
...
function Depoimentos() {
  ...
  return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
    ...
    name: "external-link",
    size: 14
  }), " Ver formulário"), /*#__PURE__*/React.createElement("button", {
    className: "btn btn-ghost",
    style: {
      fontSize: 13
    },
    ...
    name: "copy",
    size: 14
  }), " Copiar link"), /*#__PURE__*/React.createElement("a", {
    href: "../depoimentos/",
    target: "_blank",
    style: {
      display: "inline-flex",
    ...
    name: "star",
    size: 14
  }), " Página depoimentos"), /*#__PURE__*/React.createElement("button", {
    className: "btn btn-ghost",
    style: {
      fontSize: 13
    },
    ...
    name: "message-circle",
    size: 14
  }), " Sua resposta (aparece no site)"), /*#__PURE__*/React.createElement("textarea", {
    className: "form-input",
    style: {
      width: "100%",
      minHeight: 60,
    ...
    name: "save",
    size: 13
  }), " ", salvandoResposta === d.id ? "Salvando..." : "Salvar resposta")))), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      gap: 8,
      flexShrink: 0
...
function Configuracoes() {
  ...
  }, /*#__PURE__*/React.createElement("strong", null, "Dra. Lucia Kratz"), " · Psicologa Doutora · CRP 09/20590"))))), /*#__PURE__*/React.createElement("div", {
    className: "card",
    style: {
      marginBottom: 20
    }
  ...
  }, "Tipos de Laudo disponíveis"), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      flexDirection: "column",
      gap: 8,
  ...
  }, "Segurança"), /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: 13,
      color: "var(--text-muted)",
      marginBottom: 16
