...
function AbaPsicoeducacao() {
  ...
  return /*#__PURE__*/React.createElement("div", null, enviandoPsico && /*#__PURE__*/React.createElement(ModalEnviarParaPaciente, {
  ...
  }), buscaIA && /*#__PURE__*/React.createElement(BuscaIASintomaPsico, {
    itens: itens,
  ...
  }, "Próximo — Blocos ", /*#__PURE__*/React.createElement(Icon, {
    name: "arrow-right",
    size: 15
    ...
    }, bloco.tipo === "texto" ? bloco.conteudo?.slice(0, 60) || "—" : bloco.tipo === "banner" ? bloco.titulo || "—" : bloco.tipo === "lista" ? `${bloco.itens?.filter(i => i).length} item(s)` : bloco.tipo === "pergunta" ? bloco.pergunta?.slice(0, 60) || "—" : bloco.titulo || bloco.url || bloco.pergunta || "—")), /*#__PURE__*/React.createElement("button", {
...
function BuscaIASintomaPsico({
  ...
  }, "✨ ", resultado.length, " materiais recomendados:"), resultado.sort((a, b) => a.ordem - b.ordem).map((r, i) => /*#__PURE__*/React.createElement("div", {
    key: i,
    style: {
...
function RecursosTerapeuticos({
  ...
  }, "Pergunta"), /*#__PURE__*/React.createElement("input", {
    className: "form-input",
    style: {
      marginBottom: 10,
      fontSize: 13
