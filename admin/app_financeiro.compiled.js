  ...
  return /*#__PURE__*/React.createElement("div", null, modalEditarPacote && /*#__PURE__*/React.createElement("div", {
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      function CardPaciente({
        ...
        const setExpandido = fn => setExpandidosPac(prev => ({
          ...prev,
          [pacId]: typeof fn === "function" ? fn(!!prev[pacId]) : fn
        }));
        ...
        }, "⏳ ", pendentes, " pendente(s)"), pagos > 0 && /*#__PURE__*/React.createElement("span", {
          style: {
            color: "#059669",
            fontWeight: 600
          }
        }, "✓ ", pagos, " recebido(s)"), /*#__PURE__*/React.createElement("span", {
          style: {
            color: "#7B00C4",
            fontWeight: 600
          }
...
<div class="footer">Documento gerado em ${new Date().toLocaleDateString("pt-BR")} às ${new Date().toLocaleTimeString("pt-BR", {
      ...
      return pacientesVisiveis.map(pacId => /*#__PURE__*/React.createElement(CardPaciente, {
        key: pacId,
        pacId: pacId
      }));
    })());
