...
// ═══════════════════════════════════════════════════════
function RedirecionarRastreamento({
  tipo,
  paciente
}) {
  ...
  const INFO = {
    bipolar: {
      ...
      desc: "Avaliacao diferencial DSM-5 com laudo comparativo."
    },
    sexual: {
      emoji: "🌸",
      titulo: "Saude Sexual",
      desc: "Rastreamento confidencial respondido pelo proprio paciente."
    },
    alimentar: {
      emoji: "🍎",
      titulo: "Habitos Alimentares",
      desc: "Rastreamento de padroes alimentares DSM-5."
    },
    neuro: {
      emoji: "🧩",
      titulo: "Funcionamento e Comportamento",
      desc: "Rastreamento de atencao e interacao social DSM-5."
    },
    dependencia: {
      emoji: "💊",
      titulo: "Dependencia Quimica e Substancias",
      desc: "Rastreamento dos 11 criterios DSM-5."
    },
    jogos: {
      emoji: "🎮",
      titulo: "Dependencia de Jogos e Apostas",
      desc: "Rastreamento Gaming / Gambling Disorder DSM-5."
    }
  };
  ...
  }, info.desc), /*#__PURE__*/React.createElement("a", {
    href: url,
    target: "_blank",
    className: "btn btn-purple",
    style: {
...
function FerramentaAnamnese() {
  ...
  }, "🔗 Copiar mensagem para o paciente")));
}
...
function ModalVisualizarFerramenta({
  ...
  function renderFerramenta() {
    ...
    if (k === "rastreamento-bipolar") return /*#__PURE__*/React.createElement(RedirecionarRastreamento, {
      tipo: "bipolar",
      paciente: user
    });
    if (k === "rastreamento-sexual") return /*#__PURE__*/React.createElement(RedirecionarRastreamento, {
      tipo: "sexual",
      paciente: user
    });
    if (k === "rastreamento-alimentar") return /*#__PURE__*/React.createElement(RedirecionarRastreamento, {
      tipo: "alimentar",
      paciente: user
    });
    if (k === "rastreamento-neuro") return /*#__PURE__*/React.createElement(RedirecionarRastreamento, {
      tipo: "neuro",
      paciente: user
    });
    if (k === "rastreamento-dependencia") return /*#__PURE__*/React.createElement(RedirecionarRastreamento, {
      tipo: "dependencia",
      paciente: user
    });
    if (k === "rastreamento-jogos") return /*#__PURE__*/React.createElement(RedirecionarRastreamento, {
      tipo: "jogos",
      paciente: user
    });
