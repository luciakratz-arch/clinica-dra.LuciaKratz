function AbaPerfil({
  ...
  function copiarMsg() {
    const msg = "Ola, " + paciente.nome + "! 🦋\n\nSeu acesso ao portal terapeutico da Dra. Lucia Kratz esta pronto.\n\n📲 *Instale o app no seu celular (gratuito):*\n" + SITE_URL + "/\n\n👉 Ao abrir o link, toque em *Instalar App* para adicionar na tela inicial do celular.\n\n*Nome de acesso:* " + paciente.nome + "\n*Senha:* 1234\n\nApos instalar, abra o app, toque em *Paciente* e pesquise seu nome para entrar.\n\nQualquer duvida, estou a disposicao! 💜\nDra. Lucia Kratz - CRP 09/20590";
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, "👨‍👩‍👧 Responsável / Pais — para pacientes menores de idade"), /*#__PURE__*/React.createElement("div", {
    className: "form-group",
    style: {
      gridColumn: "span 2"
    }
    ...
    className: "form-label"
  }, "Nome do Responsável"), /*#__PURE__*/React.createElement("input", {
    className: "form-input",
    ...
    className: "form-label"
  }, "Parentesco / Vínculo"), /*#__PURE__*/React.createElement("select", {
    className: "form-input",
    ...
    value: ""
  }, "Selecione"), /*#__PURE__*/React.createElement("option", null, "Mãe"), /*#__PURE__*/React.createElement("option", null, "Pai"), /*#__PURE__*/React.createElement("option", null, "Avó"), /*#__PURE__*/React.createElement("option", null, "Avô"), /*#__PURE__*/React.createElement("option", null, "Tia/Tio"), /*#__PURE__*/React.createElement("option", null, "Tutor(a) legal"), /*#__PURE__*/React.createElement("option", null, "Responsável institucional"), /*#__PURE__*/React.createElement("option", null, "Outro"))), /*#__PURE__*/React.createElement("div", {
    className: "form-group"
  }, /*#__PURE__*/React.createElement("label", {
    className: "form-label"
  }, "CPF do Responsável"), /*#__PURE__*/React.createElement("input", {
    className: "form-input",
    ...
    className: "form-label"
  }, "Telefone do Responsável"), /*#__PURE__*/React.createElement("input", {
    className: "form-input",
    ...
    className: "form-label"
  }, "E-mail do Responsável"), /*#__PURE__*/React.createElement("input", {
    className: "form-input",
    type: "email",
    ...
    className: "form-label"
  }, "Nome do Segundo Responsável (opcional)"), /*#__PURE__*/React.createElement("input", {
    className: "form-input",
    ...
    className: "form-label"
  }, "Parentesco 2º Responsável"), /*#__PURE__*/React.createElement("select", {
    className: "form-input",
    ...
    className: "form-label"
  }, "Telefone 2º Responsável"), /*#__PURE__*/React.createElement("input", {
    className: "form-input",
    ...
    className: "form-label"
  }, "Observações sobre o responsável / contexto familiar"), /*#__PURE__*/React.createElement(TextAreaVoz, {
    className: "form-input",
    rows: 2,
...
function AbaEvolucao({
  ...
  return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
  ...
  }, "relaxamento")))))), rodas.length > 0 && /*#__PURE__*/React.createElement("div", {
    className: "card",
    style: {
      marginTop: 16
    }
  ...
  }, /*#__PURE__*/React.createElement("span", null, "🎯 Roda da Vida"), /*#__PURE__*/React.createElement("span", {
    style: {
      fontSize: 13,
      color: "var(--text-muted)"
    }
  }, rodas.length, " sessão(ões)")), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 12,
      color: "var(--text-muted)",
      marginBottom: 14
    }
  }, "Evolução da satisfação do paciente em cada área da vida."), rodas.length >= 2 ? (() => {
    const atual = rodas[0];
    ...
    }, "📅 Antes — ", anterior.data), /*#__PURE__*/React.createElement(RodaRadarSVG, {
      valores: vAnterior,
      cor: "#a78bfa"
    })), /*#__PURE__*/React.createElement("div", {
      style: {
    ...
    }, "📅 Agora — ", atual.data), /*#__PURE__*/React.createElement(RodaRadarSVG, {
      valores: vAtual,
      cor: "#7B00C4"
    }))), /*#__PURE__*/React.createElement("div", {
      style: {
  ...
  }, /*#__PURE__*/React.createElement(RodaRadarSVG, {
  ...
  }, rodas[0].data, " — apenas 1 sessão (comparação disponível a partir de 2)")), /*#__PURE__*/React.createElement("div", {
    style: {
      borderTop: "1px solid var(--gray-100)",
      paddingTop: 10
    }
  ...
  }, "Histórico de sessões:"), rodas.map((r, i) => /*#__PURE__*/React.createElement("div", {
    key: i,
    style: {
      fontSize: 11,
      color: "#6b7280",
  ...
  }, r.data, i === 0 ? " ✓ atual" : ""), /*#__PURE__*/React.createElement("span", {
    style: {
      fontSize: 10,
      color: "#9ca3af"
    }
  }, (r.areas || []).slice(0, 4).map(a => `${a.area.substring(0, 3)}: ${a.valor}`).join(" · "), "…"))))), /*#__PURE__*/React.createElement("div", {
    className: "card",
    style: {
      marginTop: 16
    }
